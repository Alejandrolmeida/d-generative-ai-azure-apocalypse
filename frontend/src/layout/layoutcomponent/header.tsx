      ...
      <header className="app-header">
        <div className="main-header-container container-fluid">
          <div className="header-content-left align-items-center">
            ...
            <h2>💀 <span className="text-success ms-4">D</span><span className="text-danger">Generative</span><span className="text-warning">AI</span></h2>
          </div>
          <nav className="navbar navbar-expand-lg navbar-light ">
          <h5>🔥🌩️ <span className="text-primary">Azure</span> <span className="text-danger">Apocalypse</span> <span className="text-warning">Edition</span> 🌩️🔥</h5>
          </nav>
